...
export default function kids({products}) {
  return (
    <div>
        <h2 className='text-[4vh] font-medium my-[10vh] text-center'>KIDS Section</h2>

        {products.length === 0 ? (
            <div>
                <h2 className='text-[3vh] text-center font-semibold text-red-600 mb-[4vh]'>No Products Found😔</h2>
            </div>
